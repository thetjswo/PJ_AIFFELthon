# yolo_v8_segmentation : basecode "yolo8_test_segmentation03" - 사람만 탐지하기, 20초 이상 탐지 조건
# segmentation 모델에 tracking을 추가한 모델입니다.
...
result = cv2.VideoWriter("test_video_20sec_seg.mp4",
