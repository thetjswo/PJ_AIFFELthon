# yolo8_test_tracking04 : 객체가 처음 추적된 순간부터 추적 중인 시각을 출력하되, 20초 이상일 때부터 출력
...
# 비디오 파일 및 캡처 설정
video_path = "/Users/yangh/Downloads/aiffel/00_AIFFELthon/team_project/model/test_video.mp4"
...
result = cv2.VideoWriter("test_video_20sec.mp4",
